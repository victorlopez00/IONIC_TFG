...
exports.runTask = exports.hasTask = exports.tasks = exports.loadGulp = void 0;
...
async function loadGulp() {
    if (!_gulpInst) {
        ...
        try {
            ...
            throw new Error(`Error in module: ${chalk.bold(utils_terminal_1.prettyPath(gulpFilePath))}:\n` +
        ...
        if (hasExportedFunctions) {
            try {
                ...
                throw new Error(`Cannot declare gulp v4 task, using exports: ${chalk.bold(utils_terminal_1.prettyPath(gulpFilePath))}:\n` +
                    chalk.red(e.stack ? e.stack : e));
            }
        }
...
async function tasks(gulpInst) {
    try {
        ...
        process.stderr.write(`${log_1.timestamp()} Cannot load gulp tasks: ${chalk.bold(String(e))}\n` +
            chalk.red(e.stack ? e.stack : e));
        return [];
    }
}
